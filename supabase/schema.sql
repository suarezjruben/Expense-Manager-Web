...
grant all on all routines in schema expense_manager to anon, authenticated, service_role;
grant all on all sequences in schema expense_manager to anon, authenticated, service_role;

alter default privileges for role postgres in schema expense_manager grant all on tables to anon, authenticated, service_role;
alter default privileges for role postgres in schema expense_manager grant all on routines to anon, authenticated, service_role;
alter default privileges for role postgres in schema expense_manager grant all on sequences to anon, authenticated, service_role;
